...
- **Access Control:** The new app should use Next.js Middleware to protect routes based on these roles securely.
...
- **Backend Validation:** The system prevents duplicate exam form entries (throws error code `P2002`) and ensures the payment has been completed (throws `P2025` if incomplete).
